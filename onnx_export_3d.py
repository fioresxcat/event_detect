...
if __name__ == '__main__':
    ckpt_path = 'ckpt_3d/exp2_ce_loss_remake_label_182_182_320_128/epoch=19-train_loss=0.357-val_loss=0.358-train_acc=0.989-val_acc=0.986.ckpt'
    ...
    torch.onnx.export(
        ...
        # },
        imgs,
        'ckpt_3d/exp2_ce_loss_remake_label_182_182_320_128/event_cls_3d_exp2_ep19.onnx',
        input_names=['imgs'],
        output_names=['output'],
        opset_version=14,
        dynamic_axes={
